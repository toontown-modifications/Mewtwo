...
from game.otp.friends import FriendManager
...
from game.otp.login import LoginWebPlayTokenAccount
from game.otp.login import LoginTTAccount
from game.otp.login import HTTPUtil
from game.otp.distributed import OTPClientRepository
from game.otp.distributed import PotentialAvatar
from game.otp.distributed import PotentialShard
from game.otp.distributed import DistributedDistrict
...
from game.toontown.launcher.DownloadForceAcknowledge import *
from game.toontown.distributed import DelayDelete
from game.toontown.friends import FriendHandle
from game.toontown.friends import FriendsListPanel
from game.toontown.friends import ToontownFriendSecret
from game.toontown.uberdog import TTSpeedchatRelay
from game.toontown.login import DateObject
from game.toontown.login import AccountServerDate
from game.toontown.login import AvatarChooser
from game.toontown.makeatoon import MakeAToon
from game.toontown.pets import DistributedPet, PetDetail, PetHandle
from game.toontown.toonbase import TTLocalizer
from game.toontown.toontowngui import TTDialog
from game.toontown.toon import LocalToon
from game.toontown.toon import ToonDNA
from game.toontown.distributed import ToontownDistrictStats
from game.toontown.makeatoon import TTPickANamePattern
from game.toontown.parties import ToontownTimeManager
from game.toontown.toon import Toon, DistributedToon
from .ToontownMsgTypes import *
from game.otp.distributed.OrgMsgTypes import *
from . import HoodMgr
from . import PlayGame
from game.toontown.toontowngui import ToontownLoadingBlocker
from game.toontown.hood import StreetSign
...
class ToontownClientRepository(OTPClientRepository.OTPClientRepository):
    ...
    def congratulations(self, avatarChoice):
        ...
        self.acceptedText = DirectLabel(parent=self.acceptedScreen,
                                        relief=None,
                                        text=OTPLocalizer.CRNameAccepted %
                                        newName,
                                        text_scale=0.125,
        ...
        for av in avList:
            if av.position == index:
                ...
                if base.logPrivateInfo:
                    self.notify.info('Chose avatar dna: %s' %
                                     (dna.asTuple(), ))
    ...
    def cancelAvatarDetailsRequest(self, avatar):
        avId = avatar.doId
        if avId in self._ToontownClientRepository__queryAvatarMap:
    ...
    def handleGetAvatarDetailsResp(self, di):
        ...
        gotData = 0
        if returnCode != 0:
            self.notify.warning('No information available for avatar %d.' %
                                avId)
        else:
    ...
    def dumpAllSubShardObjects(self):
        ...
        for (avId,
             pad) in list(self._ToontownClientRepository__queryAvatarMap.items()):
            pad.delayDelete.destroy()
        ...
        if isNotLive:
            self.notify.info('dumpAllSubShardObjects: doIds left: %s' %
                             list(self.doId2do.keys()))
    ...
    def identifyFriend(self, doId, source=None):
        ...
        if doId in self.doId2do:
            ...
            teleportNotify.debug('found friend %s in playerFriendsManager' %
                                 doId)
