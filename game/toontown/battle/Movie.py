...
class Movie(DirectObject.DirectObject):
    ...
    def playTutorialReward(self, ts, name, callback):
        ...
        base.camera.setPosHpr(0, 8,
                              base.localAvatar.getHeight() * 0.66, 179, 15, 0)
    ...
    def playTutorialReward_1(self):
        ...
        self.track.append(
            Func(self.rewardPanel.initGagFrame,
    ...
    def playTutorialReward_3(self, value):
        ...
        if self.questList:
            self.track1 = Sequence(
                ...
                Func(base.camera.setPosHpr, render, 34, 19.88, 3.48, -90,
                     -2.36, 0),
    ...
    def __doToonAttacks(self):
        if base.config.GetBool('want-toon-attack-anims', 1):
            ...
            ival, camIval = MovieHeal.doHeals(self.__findToonAttack(HEAL),
                                              hasHealBonus)
            if ival:
                track.append(ival)
                camTrack.append(camIval)
