...
class FireCogPanel(StateData.StateData):
    ...
    def load(self):
        ...
        self.frame = DirectFrame(relief=None,
                                 ...
                                 image_color=Vec4(1, 0.20000000000000001,
                                                  0.20000000000000001, 1))
        self.frame.hide()
        self.statusFrame = DirectFrame(parent=self.frame,
                                       relief=None,
                                       image=gui.find('**/ToonBtl_Status_BG'),
                                       image_color=Vec4(
                                           0.5, 0.90000000000000002, 0.5, 1),
                                       pos=(0.61099999999999999, 0, 0))
        self.textFrame = DirectFrame(parent=self.frame,
                                     relief=None,
