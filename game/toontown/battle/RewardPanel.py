...
class RewardPanel(DirectFrame):
    ...
    def __init__(self, name):
        ...
        self.gagExpFrame = DirectFrame(parent=self,
                                       relief=None,
                                       pos=(-0.32000000000000001, 0,
                                            0.23999999999999999))
        self.itemFrame = DirectFrame(parent=self,
                                     relief=None,
                                     text=TTLocalizer.RewardPanelItems,
                                     text_pos=(0, 0.20000000000000001),
                                     text_scale=0.080000000000000002)
        self.cogPartFrame = DirectFrame(parent=self,
                                        relief=None,
        ...
        self.cogPartLabel = DirectLabel(parent=self.cogPartFrame,
                                        text='',
                                        text_scale=0.059999999999999998)
        self.missedItemLabel = DirectLabel(parent=self.missedItemFrame,
                                           text='',
                                           text_scale=0.059999999999999998)
        self.questFrame = DirectFrame(parent=self,
                                      relief=None,
        ...
        self.newGagFrame = DirectFrame(parent=self,
                                       relief=None,
                                       ...
                                       text_scale=0.059999999999999998)
        self.endTrackFrame = DirectFrame(parent=self,
                                         relief=None,
                                         pos=(0, 0, 0.23999999999999999),
                                         text='',
                                         text_wordwrap=14.4,
                                         text_pos=(0, -0.46000000000000002),
                                         text_scale=0.059999999999999998)
        self.congratsLeft = DirectLabel(parent=self.newGagFrame,
        ...
        self.congratsRight = DirectLabel(parent=self.newGagFrame,
                                         pos=(0.20000000000000001, 0,
                                              -0.10000000000000001),
                                         text='',
                                         text_pos=(0, 0),
        ...
        self.promotionFrame = DirectFrame(parent=self,
                                          relief=None,
                                          pos=(0, 0, 0.23999999999999999),
                                          text='',
                                          text_wordwrap=14.4,
        ...
        for i in range(len(SuitDNA.suitDepts)):
            ...
            self.meritLabels.append(
                DirectLabel(parent=self.gagExpFrame,
                            relief=None,
                            text=deptName,
                            text_scale=0.050000000000000003,
            ...
            self.meritBars.append(
                DirectWaitBar(
                    ...
                    scale=0.25,
                    frameColor=(DisguisePage.DeptColors[i][0] *
                                0.69999999999999996,
    ...
    def resetMeritBarColor(self, dept):
        self.meritBars[dept]['barColor'] = (DisguisePage.DeptColors[dept][0] *
                                            0.80000000000000004,
                                            DisguisePage.DeptColors[dept][1] *
                                            0.80000000000000004,
    ...
    def getTrackIntervalList(self,
        ...
        if origSkill + \
            ...
            intervalList.append(Func(self.showTrackIncLabel, track, lostExp,
                                     1))
        else:
            intervalList.append(
