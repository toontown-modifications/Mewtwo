...
from game.toontown.safezone import SafeZoneLoader
from game.toontown.parties import Party
from game.toontown.parties.PartyGlobals import FireworksStartedEvent, FireworksFinishedEvent
...
class PartyLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def load(self):
        ...
        self.birdSound = list(map(base.loadSfx, ['phase_4/audio/sfx/SZ_TC_bird1.mp3', 'phase_4/audio/sfx/SZ_TC_bird2.mp3', 'phase_4/audio/sfx/SZ_TC_bird3.mp3']))
        self.cricketSound = list(map(base.loadSfx, ['phase_4/audio/sfx/SZ_TC_bird1.mp3', 'phase_4/audio/sfx/SZ_TC_bird2.mp3', 'phase_4/audio/sfx/SZ_TC_bird3.mp3']))
