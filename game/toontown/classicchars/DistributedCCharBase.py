...
from game.toontown.char import DistributedChar
...
class DistributedCCharBase(DistributedChar.DistributedChar):
    ...
    def __init__(self, cr, name, dnaName):
        ...
        fadeIn = self.colorScaleInterval(0.5,
                                         Vec4(1, 1, 1, 1),
    ...
    def makeTurnToHeadingTrack(self, heading):
        ...
        if time > 0.20000000000000001:
            turnTracks.append(
                Sequence(Func(self.loop, 'walk'), Wait(time),
    ...
    def fadeAway(self):
        fadeOut = self.colorScaleInterval(0.5,
                                          Vec4(1, 1, 1, 0.5),
    ...
    def enterTransitionToCostume(self):
        def getDustCloudIval():
            ...
            return Sequence(Func(dustCloud.reparentTo, self),
                            dustCloud.track,
