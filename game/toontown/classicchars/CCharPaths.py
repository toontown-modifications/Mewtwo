...
__mickeyPaths = {
    ...
    'h': (Point3(-139.94999999999999, 1.6899999999999999,
                 0.5), ('f', 'g', 'i')),
...
__mickeyWaypoints = (('a', 'e', 1, []), ('b', 'e', 1, []), ('e', 'f', 1, [
    ...
    Point3(-80.569999999999993, -4.0, -1.8500000000000001)
                     ...
                     ('h', 'i', 1, [Point3(-137.13, -42.789999999999999,
                                           0.5)]), ('i', 'f', 1, []))
__minniePaths = {
    'a': (Point3(53.334000000000003, 71.057000000000002,
                 6.5250000000000004), ('b', 'r')),
    'b': (Point3(127.756, 58.664999999999999, -11.75), ('a', 's', 'c')),
    'c': (Point3(130.32499999999999, 15.173999999999999,
                 -2.0030000000000001), ('b', 'd')),
    'd': (Point3(126.173, 7.0570000000000004,
                 0.52200000000000002), ('c', 'e')),
    'e': (Point3(133.84299999999999, -6.6180000000000003,
                 4.71), ('d', 'f', 'g', 'h')),
    'f': (Point3(116.876, 1.119, 3.3039999999999998), 'e'),
    'g': (Point3(116.271, -41.567999999999998,
                 3.3039999999999998), ('e', 'h')),
    'h': (Point3(128.983, -49.655999999999999,
                 -0.23100000000000001), ('e', 'g', 'i', 'j')),
    'i': (Point3(106.024, -75.248999999999995, -4.4980000000000002), 'h'),
    'j': (Point3(135.01599999999999, -93.072000000000003,
                 -13.375999999999999), ('h', 'k', 'z')),
    'k': (Point3(123.96599999999999, -100.242, -10.879), ('j', 'l')),
    'l': (Point3(52.859000000000002, -109.081,
                 6.5250000000000004), ('k', 'm')),
    'm': (Point3(-32.070999999999998, -107.04900000000001,
                 6.5250000000000004), ('l', 'n')),
    'n': (Point3(-40.518999999999998, -99.685000000000002,
                 6.5250000000000004), ('m', 'o')),
    'o': (Point3(-40.244999999999997, -88.634,
                 6.5250000000000004), ('n', 'p')),
    'p': (Point3(-66.299999999999997, -62.192,
                 6.5250000000000004), ('o', 'q')),
    'q': (Point3(-66.212000000000003, 23.068999999999999,
                 6.5250000000000004), ('p', 'r')),
    'r': (Point3(-18.344000000000001, 69.531999999999996,
                 6.5250000000000004), ('q', 'a')),
    's': (Point3(91.356999999999999, 44.545999999999999, -13.475), ('b', 't')),
    't': (Point3(90.355000000000004, 6.2789999999999999, -13.475), ('s', 'u')),
    'u': (Point3(-13.765000000000001, 42.362000000000002,
                 -14.553000000000001), ('t', 'v')),
    'v': (Point3(-52.627000000000002, 7.4279999999999999,
                 -14.553000000000001), ('u', 'w')),
    ...
    'y': (Point3(90.777000000000001, -49.713999999999999,
                 -13.475), ('z', 'x')),
...
__minnieWaypoints = (('a', 'b', 1, []), ('k', 'l', 1, []), ('b', 'c', 1, []),
                     ...
                     ('t', 'u', 1, []), ('x', 'y', 1, []))
__goofyPaths = {
    'a': (Point3(64.995000000000005, 169.66499999999999,
                 10.026999999999999), ('b', 'q')),
    'b': (Point3(48.893000000000001, 208.91200000000001,
                 10.026999999999999), ('a', 'c')),
    'c': (Point3(5.4820000000000002, 210.47900000000001,
                 10.029999999999999), ('b', 'd')),
...
__goofySpeedwayPaths = {
    ...
    'b': (Point3(-30.047000000000001, -1.5780000000000001,
                 -0.373), ('a', 'c')),
    ...
    'h': (Point3(21.146999999999998, -109.127,
                 -0.012999999999999999), ('g', 'i')),
    'i': (Point3(5.9809999999999999, -147.60599999999999,
                 -0.012999999999999999), ('h', 'j')),
    'j': (Point3(-24.898, -120.61799999999999,
                 -0.012999999999999999), ('i', 'k')),
    'k': (Point3(-2.71, -90.314999999999998,
                 -0.010999999999999999), ('j', 'a'))
}
__goofySpeedwayWaypoints = (('a', 'k', 1, []), ('k', 'a', 1, []))
__donaldPaths = {
    'a': (Point3(-94.882999999999996, -94.024000000000001,
                 0.025000000000000001), 'b'),
    'b': (Point3(-13.962, -92.233000000000004,
                 0.025000000000000001), ('a', 'h')),
    'c': (Point3(68.417000000000002, -91.929000000000002,
                 0.025000000000000001), ('m', 'g')),
    'd': (Point3(68.745000000000005, 91.227000000000004,
                 0.025000000000000001), ('k', 'i')),
    'e': (Point3(4.0469999999999997, 94.260000000000005,
                 0.025000000000000001), ('i', 'j')),
    ...
    'i': (Point3(43.061999999999998, 88.152000000000001,
                 0.025000000000000001), ('d', 'e')),
    'j': (Point3(-48.960000000000001, 88.564999999999998,
                 0.025000000000000001), ('e', 'f')),
    'k': (Point3(75.117999999999995, 52.840000000000003,
                 -16.620000000000001), ('d', 'l')),
...
__plutoPaths = {
    ...
    'c': (Point3(48.899999999999999, -14.4,
                 6.2000000000000002), ('b', 'a', 'd')),
    'd': (Point3(0.25, 80.5, 6.2000000000000002), ('c', 'e')),
    'e': (Point3(-83.299999999999997, 36.100000000000001,
                 6.2000000000000002), ('d', 'a'))
}
...
__chipPaths = {
    'a': (Point3(50.003999999999998, 102.72499999999999,
                 0.59999999999999998), ('b', 'k')),
    'b': (Point3(-29.552, 112.53100000000001,
                 0.59999999999999998), ('c', 'a')),
    'c': (Point3(-51.941000000000003, 146.155,
                 0.025000000000000001), ('d', 'b')),
    'd': (Point3(-212.334, -3.6389999999999998,
                 0.025000000000000001), ('e', 'c')),
    'e': (Point3(-143.46600000000001, -67.525999999999996,
                 0.025000000000000001), ('f', 'd', 'i')),
    'f': (Point3(-107.556, -62.256999999999998,
                 0.025000000000000001), ('g', 'e', 'j')),
    'g': (Point3(-43.103000000000002, -71.518000000000001,
                 0.27339999999999998), ('h', 'f', 'j')),
    'h': (Point3(-40.604999999999997, -125.124,
                 0.025000000000000001), ('i', 'g')),
    'i': (Point3(-123.05, -124.542, 0.025000000000000001), ('h', 'e')),
    'j': (Point3(-40.091999999999999, 2.7839999999999998,
                 1.268), ('k', 'b', 'f', 'g')),
