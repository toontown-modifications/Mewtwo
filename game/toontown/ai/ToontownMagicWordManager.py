...
from game.toontown.town import TownBattleAttackPanel
from game.toontown.suit import RoguesGallery
...
from game.toontown.suit import DistributedSuitPlanner
from game.toontown.suit import DistributedBossCog
from game.otp.otpbase import OTPGlobals
from direct.distributed.ClockDelta import *
from game.otp.ai import MagicWordManager
...
class ToontownMagicWordManager(MagicWordManager.MagicWordManager):
    ...
    def doMagicWord(self, word, avId, zoneId):
        ...
        if MagicWordManager.MagicWordManager.doMagicWord(self, word, avId, zoneId) == 1:
            ...
            from game.toontown.suit import DistributedSuit
            ...
            from game.toontown.coghq import MintLayout
            ...
            from game.toontown.coghq import DistributedFactory
            ...
            if not hasattr(self, 'groupPanel'):
                from game.toontown.toon import GroupPanel
    ...
    def doCatalog(self, word):
        ...
        if len(args) == 1:
            ...
            if len(args) <= 2:
                ...
                from game.toontown.catalog import CatalogGenerator
    ...
    def doNews(self, word, av, zoneId):
        ...
        if action == 'frame':
            ...
            from game.toontown.shtiker import InGameNewsFrame
