...
class MailboxScreen(DirectObject.DirectObject):
    ...
    def load(self):
        ...
        self.frame = DirectFrame(scale=1.1000000000000001,
                                 relief=DGG.FLAT,
                                 frameSize=(-0.5, 0.5, -0.45000000000000001,
        ...
        self.gettingText = DirectLabel(parent=self.frame,
                                       relief=None,
                                       text='',
                                       text_wordwrap=10,
        ...
        self.giftTagPanel = DirectLabel(parent=self.frame,
                                        relief=None,
                                        text='Gift TAG!!',
                                        text_wordwrap=16,
                                        pos=(0.0, 0.0, 0.01),
        ...
        self.itemText = DirectLabel(parent=self.frame,
                                    relief=None,
                                    text='',
                                    text_wordwrap=16,
