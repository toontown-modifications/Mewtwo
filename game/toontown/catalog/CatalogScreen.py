...
import CatalogItem, CatalogInvalidItem
...
class CatalogScreen(DirectFrame):
    ...
    def showBackPage(self):
        ...
        elif self.viewing == 'Loyalty' and self.pageIndex < 0 and self.numNewPages > 0:
            self.showNewItems(self.numNewPages - 1)
        else:
    ...
    def load(self, guiItems, guiButton, guiBack):
        ...
        self.newCatalogButton2 = DirectButton(self.base, relief=None, frameSize=(-0.2, 0.25, 0.45, 1.2), image=newDown, image_scale=(1.0, 1.0, smash), image_pos=(0.0, 0.0, lift), pressEffect=0, command=self.showNewItems, text=TTLocalizer.CatalogNew, text_font=ToontownGlobals.getSignFont(), text_pos=(-0.4 - lift, 0.13), text_scale=0.08, text_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                           1.0), text2_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                           1.0))
        self.newCatalogButton2.hide()
        self.backCatalogButton = DirectButton(self.base, relief=None, frameSize=(-0.2, 0.25, -0.2, 0.4), image=[backDown, backDown, backDown, backUp], image_scale=(1.0, 1.0, smash), image_pos=(0.0, 0.0, lift), pressEffect=0, command=self.showBackorderItems, text=TTLocalizer.CatalogBackorder, text_font=ToontownGlobals.getSignFont(), text_pos=(0.3 - lift, 0.132), text3_pos=(0.3 - lift, 0.112), text_scale=TTLocalizer.CSbackCatalogButton, text_fg=(0.392,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                0.549,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                0.627,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                1.0), text2_fg=(0.392,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                0.349,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                1.0))
        self.backCatalogButton.hide()
        self.backCatalogButton2 = DirectButton(self.base, relief=None, frameSize=(-0.2, 0.25, -0.2, 0.4), image_scale=(1.0, 1.0, smash), image_pos=(0.0, 0.0, lift), image=backDown, pressEffect=0, command=self.showBackorderItems, text=TTLocalizer.CatalogBackorder, text_font=ToontownGlobals.getSignFont(), text_pos=(0.3 - lift, 0.132), text_scale=TTLocalizer.CSbackCatalogButton, text_fg=(0.392,
                                                                                                                                                                                                                                                                                                                                                                                                    0.549,
                                                                                                                                                                                                                                                                                                                                                                                                    0.627,
                                                                                                                                                                                                                                                                                                                                                                                                    1.0), text2_fg=(0.392,
                                                                                                                                                                                                                                                                                                                                                                                                                    0.349,
                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                    1.0))
        self.backCatalogButton2.hide()
        self.loyaltyCatalogButton = DirectButton(self.base, relief=None, frameSize=(-0.2, 0.25, -0.85, -0.3), image=[newDown, newDown, newDown, newUp], image_scale=(1.0, 1.0, smash), image_pos=(0.0, 0.0, -1.4 + lift), pressEffect=0, command=self.showLoyaltyItems, text=TTLocalizer.CatalogLoyalty, text_font=ToontownGlobals.getSignFont(), text_pos=(0.95 - lift, 0.132), text3_pos=(0.95 - lift, 0.112), text_scale=0.065, text_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                                                                                                            0.627,
                                                                                                                                                                                                                                                                                                                                                                                                                                            0.627,
                                                                                                                                                                                                                                                                                                                                                                                                                                            1.0), text2_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                                                                                                                            0.427,
                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                            1.0))
        self.loyaltyCatalogButton.hide()
        self.loyaltyCatalogButton2 = DirectButton(self.base, relief=None, frameSize=(-0.2, 0.25, -0.85, -0.3), image_scale=(1.0, 1.0, smash), image_pos=(0.0, 0.0, -1.4 + lift), image=newDown, pressEffect=0, command=self.showLoyaltyItems, text=TTLocalizer.CatalogLoyalty, text_font=ToontownGlobals.getSignFont(), text_pos=(0.95 - lift, 0.132), text_scale=0.065, text_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                                                  0.627,
                                                                                                                                                                                                                                                                                                                                                                                  0.627,
                                                                                                                                                                                                                                                                                                                                                                                  1.0), text2_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                                                                  0.427,
        ...
        if len(self.ffList) > 0:
            self.giftToggle = DirectButton(self.base, relief=None, pressEffect=0, image=(giftToggleUp, giftToggleDown, giftToggleUp), image_scale=(1.0,
                                                                                                                                                   1,
                                                                                                                                                   0.7), command=self.__giftToggle, text=TTLocalizer.CatalogGiftToggleOff, text_font=ToontownGlobals.getBuildingNametagFont(), text_pos=TTLocalizer.CSgiftTogglePos, text_scale=TTLocalizer.CSgiftToggle, text_fg=(0.353,
                                                                                                                                                                                                                                                                                                                                                                   0.627,
                                                                                                                                                                                                                                                                                                                                                                   0.627,
                                                                                                                                                                                                                                                                                                                                                                   1.0), text3_fg=(0.15,
                                                                                                                                                                                                                                                                                                                                                                                   0.3,
            ...
            self.giftLabel = DirectLabel(self.base, relief=None, image=giftFriends, image_scale=(1.15,
                                                                                                 1,
                                                                                                 1.14), text=' ', text_font=ToontownGlobals.getBuildingNametagFont(), text_pos=(1.2, -0.97), text_scale=0.07, text_fg=(0.392,
                                                                                                                                                                                                                       0.549,
                                                                                                                                                                                                                       0.627,
                                                                                                                                                                                                                       1.0), sortOrder=100, textMayChange=1)
            self.giftLabel.setPos(-0.15, 0, 0.08)
            self.giftLabel.hide()
            self.friendLabel = DirectLabel(self.base, relief=None, text='Friend Name', text_font=ToontownGlobals.getBuildingNametagFont(), text_pos=(-0.25, 0.132), text_scale=0.068, text_align=TextNode.ALeft, text_fg=(0.992,
                                                                                                                                                                                                                          0.949,
                                                                                                                                                                                                                          0.327,
                                                                                                                                                                                                                          1.0), sortOrder=100, textMayChange=1)
            ...
            self.scrollList = DirectScrolledList(parent=self, relief=None, incButton_image=(gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), incButton_relief=None, incButton_pos=(0.0, 0.0, -0.316), incButton_image1_color=Vec4(1.0, 0.9, 0.4, 1.0), incButton_image3_color=Vec4(1.0, 1.0, 0.6, 0.5), incButton_scale=(1.0,
                                                                                                                                                                                                                                                                                                                                                                                                                   1.0,
                                                                                                                                                                                                                                                                                                                                                                                                                   -1.0), decButton_image=(gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), decButton_relief=None, decButton_pos=(0.0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            0.0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            0.117), decButton_image1_color=Vec4(1.0, 1.0, 0.6, 1.0), decButton_image3_color=Vec4(1.0, 1.0, 0.6, 0.6), itemFrame_pos=(-0.17, 0.0, 0.06), itemFrame_relief=None, numItemsVisible=8, items=[])
        ...
        self.catalogNumber = DirectLabel(self.cover, relief=None, scale=0.2, pos=(-0.22, 0, -0.33), text='#%d' % weekNumber, text_fg=(0.95,
                                                                                                                                      0.95,
                                                                                                                                      0,
                                                                                                                                      1), text_shadow=(0,
                                                                                                                                                       0,
        ...
        self.catalogSeries = DirectLabel(self.cover, relief=None, scale=(0.22, 1, 0.18), pos=(-0.76, 0, -0.9), text=TTLocalizer.CatalogSeriesLabel % seriesNumber, text_scale=0.5, text_fg=(0.9,
                                                                                                                                                                                            0.9,
                                                                                                                                                                                            0.4,
                                                                                                                                                                                            1), text_shadow=(0,
                                                                                                                                                                                                             0,
        ...
        self.hangup = DirectButton(self, relief=None, pos=(1.78, 0, -1.3), image=[hangupGui, hangupRolloverGui, hangupRolloverGui, hangupGui], text=['', TTLocalizer.CatalogHangUp, TTLocalizer.CatalogHangUp], text_fg=Vec4(1), text_scale=0.07, text_pos=(0.0,
        ...
        self.beanBank = DirectLabel(self, relief=None, image=guiItems.find('**/bean_bank'), text=str(base.localAvatar.getMoney() + base.localAvatar.getBankMoney()), text_align=TextNode.ARight, text_scale=0.11, text_fg=(0.95,
                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                           1), text_shadow=(0,
                                                                                                                                                                                                                                            0,
                                                                                                                                                                                                                                            0,
                                                                                                                                                                                                                                            1), text_pos=(0.75, -0.81), text_font=ToontownGlobals.getSignFont())
        ...
        self.nextPageButton = DirectButton(self, relief=None, pos=(-0.1, 0, -0.9), image=[nextUp, nextDown, nextRollover, nextUp], image_color=(0.9,
                                                                                                                                                0.9,
                                                                                                                                                0.9,
                                                                                                                                                1), image2_color=(1,
                                                                                                                                                                  1,
                                                                                                                                                                  1,
                                                                                                                                                                  1), command=self.showNextPage)
        self.backPageButton = DirectButton(self, relief=None, pos=(-0.1, 0, -0.9), image=[prevUp, prevDown, prevRollover, prevUp], image_color=(0.9,
                                                                                                                                                0.9,
                                                                                                                                                0.9,
                                                                                                                                                1), image2_color=(1,
                                                                                                                                                                  1,
                                                                                                                                                                  1,
                                                                                                                                                                  1), command=self.showBackPage)
        self.backPageButton.hide()
