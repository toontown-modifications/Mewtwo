...
class CatalogScreen(DirectFrame):
    ...
    def load(self, guiItems, guiButton, guiBack):
        ...
        itemList.sort(
            lambda a, b: priceSort(a, b, CatalogItem.CatalogTypeWeekly))
        itemList.reverse()
        ...
        self.rings = DirectLabel(self.base,
                                 relief=None,
    ...
    def loadClarabelle(self):
        ...
        self.cDr = base.win.makeDisplayRegion(0.57999999999999996,
                                              0.81999999999999995,
                                              0.53000000000000003,
                                              0.84999999999999998)
        self.cDr.setSort(1)
