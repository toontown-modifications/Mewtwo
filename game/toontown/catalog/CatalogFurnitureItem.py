...
FurnitureTypes = {
    ...
    105: ('phase_5.5/models/estate/chairAdesat', None, {
        0:
        (('**/cushion*', furnitureColors[0]), ('**/arm*', furnitureColors[0])),
        1:
        (('**/cushion*', furnitureColors[1]), ('**/arm*', furnitureColors[1])),
        2:
        (('**/cushion*', furnitureColors[2]), ('**/arm*', furnitureColors[2])),
        3:
        (('**/cushion*', furnitureColors[3]), ('**/arm*', furnitureColors[3])),
    ...
    510: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          0.84999999999999998),
    512:
    ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset, 1.0),
    514: ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset,
          1.1499999999999999),
    516:
    ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset, 1.3),
    518:
    ('phase_5.5/models/estate/closetGirl', None, None, 500, FLCloset, 1.3),
    ...
    650:
    ('phase_5.5/models/estate/UWlamp_jellyfish', None, None, 55, FLOnTable),
