...
MaxBankId = 1340
ClosetToClothes = {500: 10, 502: 15, 504: 20, 506: 25, 510: 10, 512: 15, 514: 20, 516: 25}
ClothesToCloset = {}
for (closetId, maxClothes) in ClosetToClothes.items():
    if not ClothesToCloset.has_key(maxClothes):
        ClothesToCloset[maxClothes] = (
         closetId,)
    else:
