...
from game.toontown.toon import GroupInvitee
from game.toontown.toon import GroupPanel
from game.toontown.toon import BoardingGroupInviterPanels
...
class DistributedBoardingParty(DistributedObject.DistributedObject,
    ...
    def postSizeReject(self, leaderId, inviterId, inviteeId):
        self.notify.debug('%s was not invited because the group is full' %
                          inviteeId)
