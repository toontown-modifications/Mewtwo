...
from game.toontown.effects.Firework import Firework
...
class FireworkShow(NodePath):
    ...
    def rV():
        return Vec3(random.randint(-60, 60), random.randint(10, 30),
