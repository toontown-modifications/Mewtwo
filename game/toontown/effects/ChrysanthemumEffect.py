...
class ChrysanthemumEffect(NodePath, EffectController):
    ...
    def createTrack(self):
        ...
        fadeBlast = self.effectModel.colorScaleInterval(
            ...
            blendType='easeIn')
        scaleBlast = self.effectModel.scaleInterval(0.5,
        ...
        fadeBlast2 = self.effectModel2.colorScaleInterval(
            ...
            startColorScale=Vec4(1, 1, 0.80000000000000004, 1),
            blendType='easeIn')
        scaleBlast2 = self.effectModel2.scaleInterval(1.0,
                                                      720 * self.effectScale,
                                                      startScale=250 *
                                                      self.effectScale,
                                                      blendType='easeOut')
        starsFadeIn = self.stars.colorScaleInterval(0.25,
                                                    self.effectColor,
        ...
        starsFadeOut = self.stars.colorScaleInterval(
            ...
            blendType='easeIn')
        starsScaleUp = self.stars.scaleInterval(1.5,
                                                720 * self.effectScale,
                                                startScale=660 *
                                                self.effectScale,
                                                blendType='easeOut')
        self.track = Parallel(
            ...
            Sequence(Wait(0.40000000000000002), starsFadeIn, starsFadeOut,
