...
from game.otp.level import Level
from game.otp.level import LevelConstants
from game.otp.level import Entity
from game.otp.level import EditMgr
from SpecImports import *
from InGameEditorElements import *
from game.toontown.cogdominium import CogdoEntityCreator
import string
...
class DistributedInGameEditor(DistributedObject.DistributedObject, Level.Level, InGameEditorElement):
    ...
    def setSpecSenderDoId(self, doId):
        ...
        def setSpecBlob(specBlob, blobSender = blobSender, self = self):
            blobSender.sendAck()
            from game.otp.level.LevelSpec import LevelSpec
