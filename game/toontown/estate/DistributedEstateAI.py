...
from game.toontown.safezone import DistributedButterflyAI
from game.toontown.safezone import ButterflyGlobals
from game.toontown.safezone import ETreasurePlannerAI
from game.toontown.safezone import DistributedPicnicTableAI
from game.toontown.safezone import DistributedChineseCheckersAI
...
from game.toontown.estate import DistributedChangingStatuaryAI
from game.toontown.estate import DistributedToonStatuaryAI
from game.toontown.estate import DistributedAnimatedStatuaryAI
...
#        DistributedObjectAI.DistributedObjectAI.requestDelete(self)
    ...
    def initEstateData(self, estateVal=None, numHouses=0, houseId=None, houseVal=None):
        ...
        if self.goonEnabled:
            from game.toontown.suit import DistributedGoonAI
            self.goons = [None]*3
            for i in range(3):
            ...
            from game.toontown.coghq import DistributedGagBarrelAI
            ...
            from game.toontown.coghq import DistributedBeanBarrelAI
            ...
            from game.toontown.coghq import DistributedCrateAI
    ...
    def startCannons(self, fool = 0):
        if self.cannonFlag:
            return
        from game.toontown.safezone import EFlyingTreasurePlannerAI
