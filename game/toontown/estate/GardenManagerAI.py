...
from game.toontown.estate.DistributedAnimatedStatuaryAI import DistributedAnimatedStatuaryAI
from game.toontown.estate.DistributedChangingStatuaryAI import DistributedChangingStatuaryAI
from game.toontown.estate.DistributedFlowerAI import DistributedFlowerAI
from game.toontown.estate.DistributedGagTreeAI import DistributedGagTreeAI
from game.toontown.estate.DistributedGardenBoxAI import DistributedGardenBoxAI
from game.toontown.estate.DistributedGardenPlotAI import DistributedGardenPlotAI
from game.toontown.estate.DistributedStatuaryAI import DistributedStatuaryAI
from game.toontown.estate.DistributedToonStatuaryAI import DistributedToonStatuaryAI
...
class GardenAI:
    notify = directNotify.newCategory('GardenAI')
    WANT_FLOWERS = True
    WANT_TREES = True
    WANT_STATUARY = True
