...
from game.toontown.racing.DistributedKartPadAI import DistributedKartPadAI
from game.toontown.racing.KartShopGlobals import KartGlobals
from game.toontown.toonbase import ToontownGlobals
from game.toontown.racing.RaceManagerAI import CircuitRaceHolidayMgr

class DistributedRacePadAI(DistributedKartPadAI, FSM):
    notify = directNotify.newCategory('DistributedRacePadAI')
