...
from game.otp.avatar import DistributedPlayerAI
from direct.distributed import DistributedSmoothNodeAI
from game.toontown.toonbase import ToontownGlobals
from game.toontown.quest import QuestRewardCounter
...
from game.toontown.minigame import MinigameCreatorAI
from . import ModuleListAI
from functools import reduce
if simbase.wantPets:
    from game.toontown.pets import PetLookerAI, PetObserve
else:
    class PetLookerAI:
        class PetLookerAI:
            pass
...
class DistributedToonAI(DistributedPlayerAI.DistributedPlayerAI, DistributedSmoothNodeAI.DistributedSmoothNodeAI, PetLookerAI.PetLookerAI):
    ...
    def announceZoneChange(self, newZoneId, oldZoneId):
        ...
        if simbase.air.wantWelcomeValley:
    ...
    def d_setCatalog(self, monthlyCatalog, weeklyCatalog, backCatalog):
        print(type(monthlyCatalog))
        print(type(weeklyCatalog))
        print(type(backCatalog))
    ...
    def takeOutKart(self, zoneId = None):
        if not self.kart:
            from game.toontown.racing import DistributedVehicleAI
