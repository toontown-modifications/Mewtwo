...
from game.otp.avatar.SpeedMonitor import SpeedMonitor
from game.toontown.cogdominium.CogdoMaze import CogdoMazeFactory
from game.toontown.cogdominium.DistCogdoMazeGameBase import DistCogdoMazeGameBase
...
class DistCogdoMazeGameAI(DistCogdoGameAI, DistCogdoMazeGameBase):
    ...
    def requestSuitHitByGag(self, suitType, suitNum):
        ...
        if (suitType not in {n.value for n in Globals.SuitTypes}):
