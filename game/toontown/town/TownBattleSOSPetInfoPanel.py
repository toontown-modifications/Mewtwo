...
from game.toontown.pets import Pet, PetTricks, PetDetailPanel
from game.toontown.speedchat import TTSCPetTrickMenu
from game.otp.speedchat import SpeedChatGlobals, SCSettings
