...
from game.otp.speedchat.SpeedChatTypes import *
from game.toontown.speedchat.TTSpeedChatTypes import *
from game.otp.speedchat.SpeedChat import SpeedChat
from game.otp.speedchat import SpeedChatGlobals
from game.toontown.speedchat import TTSpeedChatGlobals
from game.toontown.speedchat import TTSCSingingTerminal
from game.toontown.speedchat import TTSCIndexedTerminal
...
from game.toontown.parties.PartyGlobals import ActivityIds, DecorationIds
...
scStructure = [
    ...
    ], [OTPLocalizer.SCMenuGagShop, 1600, 1601, 1602, 1603, 1604, 1605,
        1606], {
            1: 17
        }, {
            2: 18
